...
const Sidebar = () => {
  ...
  return (
    <div className="flex ">
      ...
      <div className="md:hidden flex justify-center items-center h-[50px] w-[50px] bg-gradient-to-r from-[#2a2a2a] to-[#424242] rounded-full fixed top-0 z-50 mt-1 ml-[350px]">
