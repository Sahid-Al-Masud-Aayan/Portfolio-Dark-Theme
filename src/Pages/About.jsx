  ...
  return (
    ...
    <div className="w-[400px] lg:h-[1200px] lg:w-[1000px] md:w-[900px] bg-gradient-to-r from-[#484848] to-[#212121] rounded-3xl text-center gap-2 p-6 md:p-4 mt-[60px] mb-[60px]">
      ...
      <div data-aos="fade-up">
        <img src="./about.jpg" className='w-[220px] h-[300px] md:w-[280px] md:h-[400px] rounded-xl ml-[70px] mb-6 md:ml-0 md:mb-0 md:rounded-3xl' alt="My Image" /></div>
      <div className="flex flex-col justify-center items-center">
      <div data-aos="zoom-in-up"><p className='md:w-[600px] md:text-[18px] font-merri font-semibold text-[#e0e0e0]'>
        Hey there! I'm <span className=' text-[#ffffff] font-extrabold font-slab text-[23px]'>Aayan,</span> a skilled and dedicated Frontend React developer with a strong foundation in modern web development technologies. With expertise in <span className=' text-[#FC490B] text-[23px]'>HTML5, </span> <span className=' text-[#13A1DF] text-[23px]'>CSS3, </span>  <span className=' text-[#F7E018] text-[23px]'>JavaScript, </span> <span className=' text-[#7330FA] text-[23px]'>Bootstrap, </span> <span className=' text-[#0769AD] text-[23px]'>JQuery, </span><span className=' text-[#764ABC] text-[23px]'>Redux, </span><span className=' text-[#17A7BC] text-[23px]'>Tailwind CSS, </span><span className=' text-[#42d6ff] text-[23px]'>React </span> and <span className=' text-[#F7C52A] text-[23px]'>Firebase, </span> I am equipped to deliver high-quality, responsive, and user-friendly web applications.<br/><br/>With a strong foundation in these technologies, I have successfully delivered numerous projects, ensuring high performance, scalability, and excellent user experiences. I am passionate about clean code, modular architecture, and keeping up with the latest industry trends.
        </p></div>
      {/* Trigger Button */}
      <button
        onClick={openModal}
